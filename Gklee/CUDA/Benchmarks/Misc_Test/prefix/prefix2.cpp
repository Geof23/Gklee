...
int main(int argc, char *argv[]) 
{
	...
	int *data_loc_31 = (int*) malloc(sizeof(int));

	klee_make_symbolic(data_loc_31, sizeof(int), "data_input_31");

	data[length-1] = *data_loc_31;
...
// prefix2.C : Making final location of initial array symbolic
