...
//--buggy--> //--begin Trying buggy code suggested on page 88    
//--buggy-->     while (i != 0) {
//--buggy-->       if (cacheIndex < i) {
//--buggy--> 	cache[cacheIndex] += cache[cacheIndex + i];
//--buggy-->         __syncthreads();
//--buggy-->       }
//--buggy-->       i /= 2;
//--buggy-->     }
//--buggy--> //--end Trying buggy code suggested on page 88        
